                        ...
                        <div class="box box-primary custom_order_product_description_cls">
                            ...
                            <table class="table custom_cart_cls table-border-vertical">
                                        ...
                                        @foreach ($rooms as $room)
                                            ...
                                            @if (isset($room['products']) && count($room['products']) > 0)
                                                @foreach ($room['products'] as $each)
                                                    @php
                                                        $productData = \App\Models\Product::with('doorColor')->find($each['product_id']);
                                                        $productWeight = $productData ? $productData->weight : 0;
                                                        $productPrice = $productData ? $productData->price : 0;
                                                        $productAssembleCost = $productData ? $productData->assemble_cost : 0;
                                                        // Calculate total for each product
                                                        $totalProductWeight = $productWeight * $each['quantity'];
                                                        $totalProductPrice = $productPrice * $each['quantity'];
                                                        $totalProductAssembleCost = $productAssembleCost * $each['quantity'];

                                                    @endphp
                                                    <tr>
                                                        <td>
                                                            @if($productData->checkbox_status = 1)
                                                            <label class='container_chk_lbl'><input type='checkbox' checked
                                                                    disabled><span class='checkmark'></span></label>
                                                            &nbsp;&nbsp;<label class='container_chk_lbl_01'><input
                                                                    type='checkbox' disabled><span class='checkmark'></span>
                                                                    @else

                                                            <label class='container_chk_lbl'><input type='checkbox' checked
                                                                disabled><span class='checkmark'></span></label>
                                                        &nbsp;&nbsp;<label class='container_chk_lbl_01'><input checked
                                                                type='checkbox' disabled><span class='checkmark'></span>
                                                                @endif
                                                        </td>
                                                        ...
                                                        @php
                                                            $productAssembleCost = $productData->cost * $each['quantity'];
                                                        @endphp
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th colspan="5">Fuel Charges (2%)</th>
                                        <td>$0.00</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <th colspan="5">Pallets Cost (Total Pallets = 1)</th>
                                        <td>$</td>
                                        <td></td>
                                        <td></td>
                                    </tr <tr>
                                    <th colspan="5">Delivery Cost (Residential)</th>
                                    <td>$0.00</td>
                                    <td></td>
                                    <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th colspan="5">Unload Cost (By Forklift)</th>
                                        <td>$150.00</td>
                                        <td></td>
                                        <td></td>
                                    </tr>
