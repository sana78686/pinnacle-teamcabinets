    ...
    <div class="m-2 card-body">
        <form method="POST" action="{{ route('tenant_user_update', $user->id) }}">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel">Edit Product Catalog Visibility & Point Factors</h5>
                                                    ...
                                                    <div class="mb-2 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                class="form-control"
                                                                value="{{ $existing_factors[$product_catalog->id][$door_color->id] ?? '' }}">
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
            ...
            <div class="m-2 row">
                        ...
                        <select class="js-example-basic-single col-sm-12 form-control b-r-0" id="search_state"
                            ...
                            @if ($user->state_id)
                                @foreach ($states as $id => $name)
                                    <option value="{{ $id }}"
                                        {{ old('state_id', $user->state_id) == $id ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                @endforeach
                            @endif
                ...
                <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <input class="js-example-basic-single col-sm-12 form-control b-r-0" id="search_city"
                            name="city_id" {{ $user->city }} required>
                        {{-- @if ($user->city_id)
                            @foreach ($cities as $id => $name)
                                <option value="{{ $id }}"
                                    {{ old('city_id', $user->city_id) == $id ? 'selected' : '' }}>
                                    {{ $name }}
                                </option>
                            @endforeach
                            @endif --}}
                ...
                <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4 ">
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-single col-sm-12 form-control b-r-0" id="search_county"
                            name="county_id" required autofocus>
                        </select>
                    </div>
                </div>
                ...
                <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="zip_code" placeholder="Enter the ZIP code" class="form-control"
                            required data-toggle="tooltip" title="Provide the postal code for the user's address"
                            autofocus value="{{ $user->zip_code }}">
                    </div>
                </div>
                ...
                <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="address" rows="2" placeholder="Enter the full address">{{ $user->address }}</textarea>
                    </div>
                </div>
                ...
                <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea4" rows="2"
                            placeholder="Type something about this user." name="note"></textarea>
                    </div>
                </div>
                ...
                <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" name=" Business Name" placeholder=" Business Name" class="form-control">
                    </div>
                </div>
                ...
                <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="Gross Sales" placeholder=" Gross Sales" class="form-control">
                    </div>
                </div>
                <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
                    <div class="form-group">
            ...
            <div class="text-center col-xs-12 col-sm-12 col-md-12">
                <button type="submit" class="mt-2 mb-3 btn btn-primary btn-sm"> Update</button>
            </div>
        </form>
    </div>
@endsection
