...
$('.mobile-sidebar #sidebar-toggle').click(function(e) {
  if ($('#pn-admin-sidebar').length) {
    return;
  }
 ...
 if ($(window).width() <= 991) {
  var $pnSidebar = $('#pn-admin-sidebar');
  if ($pnSidebar.length) {
    $pnSidebar.addClass('iconbar-second-close').removeClass('iconbar-mainmenu-close');
  } else {
