                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 20px 20px 20px 20px;">
									...
									<td colspan="3">
									 <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background:#f5f5f5;color: #333; font-family: Arial, sans-serif; font-size:13px; line-height:20px;">
										...
										<tr>
										    ...
										    <td style="padding: 3px 10px;color:#000;font-size:14px; white-space:nowrap;"><b>Stock Check ID #:</b> <?php echo $email_data['ship_quote_id']; ?> </td>
										</tr>
										<tr>
										    <td style="padding: 3px 10px;color:#000;font-size:14px;" valign="top"><b>Address:</b> <?php echo $email_data['bill_to_address'].", ".$email_data['bill_to_city'].", <br>".$email_data['bill_to_county'].", ".$email_data['bill_to_state'].", ".$email_data['bill_to_zipcode'].", ".$email_data['bill_to_country'];  ?></td>
										    ...
										    <td style="padding: 3px 10px;color:#000;font-size:14px;" valign="top" valign="top"><b>Date:</b> 
										    	<?php
										...
										<tr>
										    <td style="padding: 3px 10px;color:#000;font-size:14px;"><b>Email:</b> <?php echo getFirstEmail($email_data['bill_to_email']);  ?> </td>
										    <td style="padding: 3px 10px;color:#000;font-size:14px;"><b>Email:</b> <?php echo getFirstEmail($email_data['ship_to_email']);  ?> </td>
										...
										<tr>
										 ...
										 <tr>
										   <td colspan="3" height="10" style="padding: 3px 10px 10px;color:#000;font-size:14px;">
									  ...
									  <td colspan="3">
									    <table border="0" cellpadding="5" cellspacing="0" width="100%" style="color: #333; font-family: Arial, sans-serif; font-size:14px; line-height:20px;">
										  <tr style="background:#f5f5f5;">
										   ...
										   <td style="padding: 5px 10px;color:#000;font-size:14px;" valign="middle"><b>Product</b></td>
										   <td style="padding: 5px 10px;color:#000;font-size:14px;" valign="middle"><b>Description</b></td>
										   <td align="right" style="padding: 5px 10px;color:#000;font-size:14px;" valign="middle"><b>Quantity</b></td>
										   <?php if($email_data['is_updated'] == 1){ ?>
										   <td align="right" style="padding: 5px 10px;color:#000;font-size:14px;" valign="middle"><b>Unit Price</b></td>
										   <td align="right" style="padding: 5px 10px;color:#000;font-size:14px;" valign="middle"><b>Amount</b></td>
										   <?php 
											if($email_data['is_assemble'] == 1) 
											{ $extra_row ="<td style='border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;'></td>";	
											?>
										   <td align="right" style="padding: 5px 10px;color:#000;font-size:14px;" valign="middle"><b>Assemble Cost</b></td>
										   <?php } else { $extra_row =""; }  
										   
										   } else { ?>
										   <td align="right" style="padding: 5px 10px;color:#000;font-size:14px;" valign="middle"><b>Weight</b></td>
										   <?php } ?>
								...
								foreach($room_data as $key => $val)
								{
									...
									foreach($cart_product as $cart_product1)
									{
										...
										<tr>
										  ...
										  <td style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px; white-space:nowrap;"><?php echo $cart_product1['sku']." - ".$cart_product1['product_cabinets_color']; ?></td>
										   <td style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;"><?php echo $cart_product1['product_details']; ?></td>
											...
											?>
												<td style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;" align="right"><?php echo $cart_product1['weight'] * $cart_product1['quantity']." lbs"; ?></td>
											<?php } ?>
										</tr>
										<?php
									}		
							...
							?>
										  ...
										  <?php echo $extra_row; ?>
										    <td colspan="2" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;" align="right"><b>SUB TOTAL</b></td>
											  <?php
												//$all_total = 0;
												if($email_data['is_updated'] == 1){
													echo '<td align="right" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px; white-space:nowrap;"></td>';
													echo '<td align="right" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px; white-space:nowrap;">$'.number_format((float)$all_total, 2, '.', '').'</td>';
												} else {
													$all_total = $all_weight_total;
													echo '<td align="right" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px; white-space:nowrap;">'.$all_total.' lbs</td>';
												}
											   ?>
										</tr>
										...
										<?php 
											if($email_data['is_assemble'] == 1 && $email_data['is_updated'] == 1) 
											{
										...
										if($email_data['is_updated'] == 1){
											...
											if($email_data['is_shipping_required'] == 1){
												$pallets =  $email_data['total_pallets'];
											...
											<?php } else { 
											 ...
											 $shipping_charges = $email_data['shipping_cost'];	
											?>
											...
											<tr>
												...
												<td style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;"></td>
												<?php echo $extra_row; ?>
												<td colspan="2" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;" align="right"><b>SHIPPING CHARGES</b></td>
												 <td style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;" align="right"></td>
												  <td style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;" align="right"><?php echo "$".number_format((float)$email_data['shipping_cost'], 2, '.', '');  ?></td>
											</tr>
										   ...
										   <?php echo $extra_row; ?>
										    <td colspan="2" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px;" align="right"><b>TOTAL</b></td>
											 <?php 
											            $grand_total = 0;
											            if($email_data['is_updated'] == 1){
															$grand_total = $all_total + $shipping_charges + $assembly_charges ;
															echo '<td align="right" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px; white-space:nowrap;"></td>';
															echo '<td align="right" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px; white-space:nowrap;">$'.number_format((float)$grand_total, 2, '.', '').'</td>';
														} else {
															$grand_total = $all_weight_total;
															echo '<td align="right" style="border-bottom:1px solid #ddd;padding: 5px 10px;color:#000;font-size:14px; white-space:nowrap;">'.$grand_total.' lbs</td>';
														}														
													?>
										</tr>
