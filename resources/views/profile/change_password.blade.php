                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="new-password" name="new_password"
                                            type="password" placeholder="Enter a new password (at least 8 characters)"
                                            required>
                                        @error('new_password')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                ...
                {{-- <form class="f1" method="post">
                    <fieldset>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="old-password" title="Enter the password you are currently using.">Old
                                        Password</label>
...
<script src="{{ asset('assets/main/js/form-wizard/form-wizard-five.js') }}"></script>
<script src="{{ asset('assets/main/js/form-wizard/form-wizard-three.js') }}"></script>
<script src="{{ asset('assets/main/js/form-wizard/jquery.backstretch.min.js') }}"></script>
