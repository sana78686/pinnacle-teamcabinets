...
@section('content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="{{ route('tenant_deleted_products_list') }}" class="btn btn-success btn-sm" data-toggle="tooltip"
        ...
        <div class=" pull-right">
            ...
            <a href="{{ route('product.export') }}" class="btn btn-primary btn-sm" data-toggle="tooltip"
