...
@section('content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="{{ route('tenant_product_index') }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted user">
            <i class="icofont icofont-listing-number"></i> Products List
        </a>
            ...
            <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $product->image }}</td>
                        <td>
                            <a href="{{ route('tenant_products_restore',$product->id) }}"
                                data-toggle="tooltip"
