...
@section('breadcrumb-title')
    <h2>Create<span>Credit/Debit/Ach Charges Details</span></h2>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">setting</li>
    <li class="breadcrumb-item active">Credit/Debit/Ach</li>
@endsection

@section('setting_content')
<div class="p-2 mt-0 card-header no-border">
    {{-- <h5>Best Selling Product</h5> --}}
    <a href="{{ route('tenant_setting_manage_credit_list') }}" class="text-white btn btn-info btn-sm" data-toggle="tooltip"
        title="Create a new user in the system">
        <i class="icofont icofont-plus"></i> Create Credit/Debit/Ach
    </a>

    <a   href="{{ route('tenant_deleted_manage_credit_list') }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted user">
        <i class="icofont icofont-spinner-alt-3"></i> Restore Credit/Debit/Ach
    </a>
    ...
    <div class="table-responsive table-sm">
        <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Credit Card Charges</th>
                    <th scope="col">ACH Charges</th>
                    <th scope="col">Debit Card Charges  </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('tenant_setting_manage_credit_show',1) }}" data-toggle="tooltip" title="View details of this user">
                            Show |
                        </a>

                        <a class="" href="{{ route('tenant_setting_manage_credit_edit',1) }}" data-toggle="tooltip" title="Edit this user's information">
                            Edit |
                        </a>
