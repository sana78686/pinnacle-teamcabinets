<div class="page-main-header">
  <div class="main-header-right">
    <div class="text-center main-header-left">
      <div class="logo-wrapper"><a href="{{route('/')}}"><img src="{{dynamic_url('backend/images/logo/logo.png')}}" alt=""></a></div>
    </div>
    ...
    <div class="nav-right col pull-right right-menu">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning" src="{{dynamic_url('backend/images/dashboard/bookmark.png')}}" alt="">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-secondary" src="{{dynamic_url('backend/images/dashboard/like.png')}}" alt="">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning" src="{{dynamic_url('backend/images/dashboard/notification.png')}}" alt="">
          <ul class="onhover-show-div notification-dropdown">
            ...
            <li>
              <div class="media">
                <div class="mr-3 notification-icons bg-success"><i class="mt-0" data-feather="thumbs-up"></i></div>
            ...
            <li class="pt-0">
              <div class="media">
                <div class="mr-3 notification-icons bg-info"><i class="mt-0" data-feather="message-circle"></i></div>
                <div class="media-body">
        ...
        <li><a class="right_side_toggle" href="#"><img class="img-fluid img-shadow-success" src="{{dynamic_url('backend/images/dashboard/chat.png')}}" alt=""></a></li>
        <li class="onhover-dropdown"> <span class="media user-header"><img class="img-fluid" src="{{dynamic_url('backend/images/dashboard/user.png')}}" alt=""></span>
          <ul class="onhover-show-div profile-dropdown">
            <li class="gradient-primary">
              <h5 class="mb-0 f-w-600">Elana Saint</h5><span>Web Designer</span>
            </li>
