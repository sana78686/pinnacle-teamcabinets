...
@section('breadcrumb-title')
    <h2>About Us<span> Setting Details</span></h2>
@endsection
...
<div class="p-2 mt-0 card-header no-border">
    ...
    <a href="{{ route('tenant_setting_manage_about_List') }}" class="text-white btn btn-info btn-sm" data-toggle="tooltip"
        title="Create a new user in the system">
        <i class="icofont icofont-plus"></i> Create About Us Setting
    </a>

    <a   href="{{ route('tenant_deleted_manage_about_list') }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted user">
        ...
        <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('tenant_setting_manage_about_show',1) }}" data-toggle="tooltip" title="View details of this user">
                            Show |
                        </a>

                        <a class="" href="{{ route('tenant_setting_manage_about_edit',1) }}" data-toggle="tooltip" title="Edit this user's information">
                            Edit |
                        </a>
