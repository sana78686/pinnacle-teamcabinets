...
<div class="box box-primary">
	<div style="width:100%;float:left;">
		<?php $username =  $user_results['0']['username'];?> 
		<label>Hello <?php echo $username;?>,</label>
	</div>
	<div style="width:100%;float:left;">
		<label><br>Your claim request has been submitted successfully. Please find below the product details:</label>  
	</div>
	<div style="width:100%;float:left;">
		<div class="job_name_cls" style="">
			<br><b>Job Name</b> - <?php  echo $job_name; ?>
		</div><br>
		<label><b>Product Detail:</b></label>
