    ...
    <div class="m-2 card-body">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="p-2 col-lg-4">
                    <div class="form-group">
                        <label>Inventory Val<span class="asterisk"> *</span></label>
                        <input name="inventory_val" type="text" step="0.01" class="form-control" required>
                    </div>
                </div>
                <div class="p-2 col-lg-4">
                    <div class="form-group">
                ...
                <div class="text-center col-12">
                    <button type="submit" class="btn btn-info" style="margin: 15px;">Create Quote</button>
                </div>
        </form>
    </div>
