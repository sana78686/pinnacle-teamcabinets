...
@section('content')
                    <div class="bg-white h-100 d-flex justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            <div class="mb-5">
                                <img src="{{ asset('assets/logo/team_cabinets.jpg') }}" alt="Team Cabinets" style="height: 70px"/></div>
                            <h4 class="mb-0">
