...
@section('breadcrumb-title')
    <h2>Create<span> Success/Error Content</span></h2>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Create</li>
    <li class="breadcrumb-item active">Success</li>
    <li class="breadcrumb-item active">Error Content</li>
@endsection
...
<div class="row g-3 tc-settings-form-row">
    ...
    <div class="col-md-4 ">
        <div class="form-group">
            ...
            <input class="form-control" name="" id="" type="text" placeholder="Pages " required autofocus>
        </div>
    </div>
    <div class="col-12 tc-settings-form-actions">
        <button type="submit" class="mt-2 mb-3 btn btn-primary btn-sm"><i class="fa-solid fa-floppy-disk"></i>
           Create Success/Error Content</button>
    </div>
</div>
