...
@section('breadcrumb-title')
    <h2>Update <span>Commission Report </span></h2>
@endsection
        ...
        <div class="row">
            ...
            <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
                <div class="form-group">
                    ...
                    <input type="" class="form-control" id="catalogue_image" name="catalogue_image" required>
                    <span class="err" style="color: red;"></span>
                </div>
            </div>
            <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-4">
            ...
            <div class="text-center col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <input name="btn_submit" id="btnCabinet" type="submit" class="btn btn-info"
                        value="Create Commission Report" style="margin: 15px;">
                </div>
            </div>
        </div>
    </form>
