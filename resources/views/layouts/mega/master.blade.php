...
<html lang="en">
   <head>
      ...
      <link rel="icon" href="{{ asset('assets/logo/pinnacle-favicon.png') }}" type="image/x-icon">
      <link rel="shortcut icon" href="{{ asset('assets/logo/pinnacle-favicon.png') }}" type="image/x-icon">
   ...
   <body class="pn-admin-panel">
      ...
      <div class="loader-wrapper">
         <div class="typewriter">
            <h1>Pinnacle Super-User Dashboard Loading..</h1>
         </div>
      </div>
      <!-- Loader ends-->
      <!-- page-wrapper Start-->
