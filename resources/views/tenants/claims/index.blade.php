...
@section('content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="{{ route('tenant_claim_create') }}" class="text-white btn btn-info btn-sm" data-toggle="tooltip"
            title="Create a new Claims in the system">
            <i class="icofont icofont-plus"></i> Create Claims
        </a>
        <a href="{{ route('tenant_deleted_claim_list') }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted Claims">
            <i class="icofont icofont-spinner-alt-3"></i> Restore Claims
        </a>
        ...
        <div class=" pull-right">
            ...
            <button class="btn btn-primary btn-sm" data-toggle="tooltip" title="Export Claims data to a file">
                <i class="text-white icofont icofont-upload-alt"></i> Export
            </button>
            <button class="btn btn-dark btn-sm" data-toggle="tooltip" title="Import Claims data from a file">
        ...
        <div class="table-responsive table-sm">
            <table class="table display table-striped table-bordered table-sm " id="catalogTable">
                ...
                <tbody>
                    ...
                    <td>
                        <a class="" href="" data-toggle="tooltip" title="View details of this user">
                            Show |
                        </a>

                        <a class="" href="" data-toggle="tooltip" title="Edit this user's information">
                            Edit |
                        </a>
