<div class="page-main-header">
    <div class="main-header-right">
        <div class="text-center main-header-left">
            <div class="logo-wrapper"><a href="{{ route('/') }}"><img
                        src="{{ url('assets/main/images/logo/logo.png') }}" alt=""></a></div>
        </div>
        <div class="mobile-sidebar d-none">
            <div class="text-right media-body switch-sm">
                <label class="ml-3 switch"><i class="font-primary" id="sidebar-toggle"
        ...
        <div class="nav-right col pull-right right-menu">
            <ul class="nav-menus">
                            ...
                            <div class="Typeahead Typeahead--twitterUsers">
                                <div class="u-posRelative">
                                    <input class="Typeahead-input form-control-plaintext" id="demo-input" type="text"
                                        name="q" placeholder="Search Your Product...">
                ...
                <li class="onhover-dropdown"><i data-feather="bell"></i>
                    {{-- <img class="img-fluid img-shadow-warning"
                        src="{{ url('assets/main/images/dashboard/notification.png') }}" alt=""> --}}
                    <ul class="onhover-show-div notification-dropdown">
                        ...
                        <li>
                            <div class="media">
                                <div class="mr-3 notification-icons bg-success"><i class="mt-0"
                        ...
                        <li class="pt-0">
                            <div class="media">
                                <div class="mr-3 notification-icons bg-info"><i class="mt-0"
                ...
                {{-- <li>
                    <a class="right_side_toggle" href="#">
                        <img class="img-fluid img-shadow-success"
                            src="{{ url('assets/main/images/dashboard/chat.png') }}" alt="">
                    </a>
                </li> --}}
                <li class="onhover-dropdown">
                    <span class="media user-header">
                        ...
                        {{-- <img class="img-fluid" src="{{ url('assets/main/images/dashboard/user.png') }}"
                            alt=""> --}}
                    </span>
                    <ul class="onhover-show-div profile-dropdown">
                        <li class="gradient-primary">
                            <h5 class="mb-0 f-w-600">{{ auth()->user()->name ?? 'Pinnacle' }}</h5>
                ...
                <li><a class="font-lg text-dark" href="#!" onclick="javascript:toggleFullScreen()"><i
