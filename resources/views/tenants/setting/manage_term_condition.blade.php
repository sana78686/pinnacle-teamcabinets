...
@section('breadcrumb-title')
    <h2>Create<span> Term & Conditionn</span></h2>
@endsection
...
<div class="row g-3 tc-settings-form-row">
    ...
    <div class="col-md-4 ">
        <div class="form-group">
            ...
            <input class="form-control" name="" id="" type="text" placeholder="Description" required autofocus>
        </div>
    </div>
    <div class="col-md-4 ">
        <div class="form-group">
            <strong>Description For Shipping Quote &nbsp;<span class="txt-danger"></span></strong>
            <input class="form-control" name="" id="" type="text" placeholder="Description For Shipping Quote" required autofocus>
        </div>
    </div>
