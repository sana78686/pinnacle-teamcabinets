...
@section('content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="{{ route('tenant_order_create') }}" class="text-white btn btn-info btn-sm" data-toggle="tooltip"
            title="Create a new Order in the system">
            <i class="icofont icofont-plus"></i> Create Order
        </a>
        <a href="{{ route('tenant_order_list') }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted Order">
            <i class="icofont icofont-listing-number"></i> Order List
        </a>
            ...
            <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
                ...
                <tbody>
                    <tr>
                      ...
                      <td>san.bism786illah@gmail.com</td>
                      <td>testing-job</td>
                      <td>N/A</td>
                      <td>96 lbs</td>
                      <td>$1,311.00</td>
                      ...
                      <td>Jan, 19 2025</td>
                        <td>
                            <a href="{{ route('tenant_order_restore', 1) }}"
                                data-toggle="tooltip"
