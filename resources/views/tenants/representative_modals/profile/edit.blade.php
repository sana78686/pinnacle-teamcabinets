                        ...
                        <form class="f1" method="post">
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="f1-first-name">Domain Name</label>
                                            <input class="form-control" id="f1-first-name" type="text"
                                                name="f1-first-name" placeholder="name@example.com" required="">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="f1-first-name">Contact</label>
                                            <input class="form-control" id="f1-first-name" type="text"
                                                name="f1-first-name" placeholder="name@example.com" required="">
                                        </div>
                                        <div class="form-group">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="f1-repeat-password form-control" id="f1-repeat-password"
                                        type="password" name="f1-repeat-password" placeholder="Repeat password..."
                                        required="">
                                </div>
                                <div class="f1-buttons">
