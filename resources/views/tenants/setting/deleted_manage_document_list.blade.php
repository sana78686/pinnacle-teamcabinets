...
@section('breadcrumb-title')
    <h2>Document Setting <span>List </span></h2>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Document Setting</li>
...
@section('setting_content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted document">
            <i class="icofont icofont-listing-number"></i> Document Setting List
        </a>
            ...
            <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('tenant_manage_document_restore', 1) }}"
                                data-toggle="tooltip"
