...
<div class="p-2 mt-0 card-header no-border">
    ...
    <a href="{{ route('tenant_setting_manage_success_list') }}" class="text-white btn btn-info btn-sm" data-toggle="tooltip"
        ...
        <i class="icofont icofont-plus"></i> Create Success Setting
    </a>
    ...
    <a   href="{{ route('tenant_deleted_manage_success_list') }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted user">
        <i class="icofont icofont-spinner-alt-3"></i> Restore  Success Setting
    </a>
        ...
        <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <a href="{{ route('tenant_setting_manage_success_show',1) }}" data-toggle="tooltip" title="View details of this user">
                            Show |
                        </a>
                        <a class="" href="{{ route('tenant_setting_manage_success_edit',1) }}" data-toggle="tooltip" title="Edit this user's information">
                            Edit |
                        </a>
