...
@include('layouts.tenant.partials.website-designing-nav')
    ...
    <div class="tc-settings-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
        <div>
            <h5 class="mb-1 tc-settings-form-title">Blog</h5>
            <p class="mb-0 text-muted tc-field-hint">Edit the blog landing page and publish posts shown on your storefront.</p>
        </div>
