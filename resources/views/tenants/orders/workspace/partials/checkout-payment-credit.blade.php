        ...
        <div class="tc-checkout__pay-fields">
            <div class="row g-1">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="checkout_address" class="form-control form-control-sm"
                        value="{{ old('checkout_address', $cartData['bill_to_address'] ?? '') }}">
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="expiry_date" class="form-control form-control-sm" placeholder="MM/YY" title="Format: MM/YY e.g. 09/25" value="{{ old('expiry_date') }}">
