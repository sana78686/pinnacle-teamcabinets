        ...
        <div class="row">
            ...
            {{-- <div class="p-2 col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="assemble_price" placeholder="Cabinet Assemble Cost" class="form-control"
                        required autofocus>
                </div>
            </div> --}}
            <div class="text-center col-xs-12 col-sm-12 col-md-12">
                <button type="submit" class="mt-2 mb-3 btn btn-success btn-sm"><i class="fa-solid fa-floppy-disk"></i>
