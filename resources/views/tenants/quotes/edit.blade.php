        ...
        <div class="row">
            <div class="p-2 col-lg-4">
                <div class="form-group">
                    <label>Quote Name<span class="asterisk"> *</span></label>
                    <input  value="Quote Name" name="bill_name" type="text" class="form-control" required>
                </div>
            </div>
            <div class="p-2 col-lg-4">
                <div class="form-group">
                    <label>Bill Name<span class="asterisk"> *</span></label>
                    <input  value="Bill Name" name="bill_name" type="text" class="form-control" required>
                </div>
            </div>
            ...
            <div class="p-2 col-lg-4">
                <div class="form-group">
                    ...
                    <input  value="Bill Name" name="ship_name" type="text" class="form-control" required>
                </div>
            </div>
            ...
            <div class="p-2 col-lg-4">
                <div class="form-group">
                    ...
                    <input  value="Bill Name" name="job_name" type="text" step="0.01" class="form-control" required>
                </div>
            </div>
            ...
            <div class="p-2 col-lg-4">
                <div class="form-group">
                    ...
                    <input  value="Bill Name" name="date" type="date" step="0.01" class="form-control" required>
                </div>
            </div>
            <div class="text-center col-12">
                <button type="submit" class="btn btn-info" style="margin: 15px;">Update Quote</button>
            </div>
    </form>
</div>
