...
@section('content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="{{ route('tenant_bulletin_create') }}" class="text-white btn btn-info btn-sm" data-toggle="tooltip"
            title="Create a new Bulletins in the system">
            <i class="icofont icofont-plus"></i> Bulletins Order
        </a>
        <a href="{{ route('tenant_bulletin_index') }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted Bulletins">
            <i class="icofont icofont-listing-number"></i> Bulletins List
        </a>
        ...
        <div class=" pull-right">
            ...
            <button class="btn btn-primary btn-sm" data-toggle="tooltip" title="Export Bulletins data to a file">
                <i class="text-white icofont icofont-upload-alt"></i> Export
            </button>
            <button class="btn btn-dark btn-sm" data-toggle="tooltip" title="Import Bulletins data from a file">
            ...
            <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Select User Send Option</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $bulletin->image }}</td>
                          <td>
                              <a href="{{ route('tenant_bulletin_restore', $bulletin->id) }}"
                                  data-toggle="tooltip"
                                  title="View details of this Bulletin" >
                                  Restore
                              </a>
                          </td>
                      </tr>
