...
@section('content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="{{ route('tenant_product_catalog_index') }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted Product Catalog">
            <i class="icofont icofont-listing-number"></i> Product Catalog List
        </a>
    ...
    <div class="pt-0 card-body">
        <div class="table-responsive table-sm">
            <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
                ...
                <tbody>
                @forelse($product_catalog as $product_catalog)
                    <tr>
                       ...
                       <td> {{$product_catalog->image}}</td>
                        ...
                        <td>
                            <a href="{{ route('tenant_product_catalog_restore', $product_catalog->id) }}"
                                data-toggle="tooltip"
                                title="View details of this product catalog" >
                                Restore
                            </a>
        ...
        @include('partials.tenant-pagination', ['paginator' => $product_catalog])
    </div>
