...
@section('content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="{{ route('tenant_claim_create') }}" class="text-white btn btn-info btn-sm" data-toggle="tooltip"
            ...
            <i class="icofont icofont-plus"></i> Claims Order
        </a>
        <a href="" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted user">
            <i class="icofont icofont-listing-number"></i> Claims List
        </a>
            ...
            <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
                ...
                <tbody>
                    <tr>
                      ...
                      <td>testing-job</td>
                        <td>
                            <a href="{{ route('tenant_claim_restore', 1) }}"
                                data-toggle="tooltip"
