...
{
    /**
     * CI door-factor columns on users (shared DB — same users table used by tenants).
     * Mirror: database/migrations/tenant/2026_05_24_120000_add_ci_door_factor_columns_to_users_table.php
     */
