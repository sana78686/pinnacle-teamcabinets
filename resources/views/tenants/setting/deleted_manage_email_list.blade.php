...
@section('breadcrumb-title')
    <h2>Email Setting <span>List </span></h2>
@endsection
...
@section('setting_content')
    <div class="p-2 mt-0 card-header no-border">
        ...
        <a href="" class="btn btn-success btn-sm" data-toggle="tooltip" title="Restore a previously deleted user">
            <i class="icofont icofont-listing-number"></i> Email Setting List
        </a>
        ...
        <div class="table-responsive table-sm">
            <table class="table p-0 m-0 display table-striped table-bordered table-sm" id="">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>1</td>
                    <td> Registration Email For Admin</td>
                        <td>
                            <a href="{{ route('tenant_manage_email_content_restore', 1) }}"
                                data-toggle="tooltip"
