...
<head>
    ...
    <link rel="icon" href="{{ tenant_asset('assets/logo/pinnacle-favicon.png') }}" type="image/png">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.5.0/css/all.min.css">
    <link rel="stylesheet" href="{{ tenant_asset('css/tenant-auth.css') }}?v=6">
...
<body class="tc-auth-body">
    ...
    <script src="{{ tenant_asset('js/tenant-tooltips.js') }}?v=1"></script>
