        ...
        $configs = [
            ...
            'categories' => [
                ...
                'columns' => [
                    ...
                    ['key' => 'assemble_price', 'label' => 'Assemble cost'],
                ],
                'showFields' => [
                    ['key' => 'id', 'label' => 'ID'],
                    ['key' => 'cabinets_name', 'label' => 'Category / Cabinet Section'],
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'type' => 'number',
                        'placeholder' => 'Enter assemble cost, e.g. 30',
            ...
            'products' => [
                ...
                'showFields' => [
                    ...
                    ['key' => 'cost', 'label' => 'Cost'],
                    ['key' => 'assemble_cost', 'label' => 'Assemble cost'],
                    ['key' => 'qty', 'label' => 'Qty'],
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'label' => 'Weight',
                        'required' => true,
                        'placeholder' => 'Enter weight in lbs, e.g. 38',
                    ...
                    [
                        ...
                        'type' => 'number',
                        'required' => true,
                        'placeholder' => 'Enter cost, e.g. 201.60',
                        'tip' => 'Internal cost used for margin and commission reports.',
                    ],
                    [
                        'name' => 'assemble_cost',
                        'label' => 'Assemble cost',
                        'type' => 'number',
                        'placeholder' => 'Enter assemble cost, e.g. 20',
