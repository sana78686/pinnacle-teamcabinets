...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/create-order.css') }}?v=8">
    <link rel="stylesheet" href="{{ asset('css/tenant-panel.css') }}?v=34">
    <link rel="stylesheet" href="{{ asset('css/order-workspace.css') }}?v=11">
    <link rel="stylesheet" href="{{ asset('css/tenant-order-theme.css') }}?v=1">
    @yield('style')
    @stack('head')
</head>
