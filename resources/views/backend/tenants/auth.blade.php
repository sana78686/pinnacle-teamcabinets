...
@section('custom_css')
    ...
    <style>
        ...
        .register_bg{
            background-image: linear-gradient(#EDDE5D , #000);
        }
        .mobile_mode{
            height: 100vh;
            overflow: hidden;
...
@section('content')
    ...
    <div class="desktop_mode login_bg" id="desktop_mode">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
            <div class="m-0 row w-75">
                ...
                {{-- FORM --}}
                <div class="p-5 col-6 border-rightside d-flex align-items-center" style="background-color: white;" id="right_form">
                    ...
                    <div id="login_form_holder" class="login_form_holder w-100">
                        ...
                        <form action="/checkLogin" method="POST">
                            ...
                            <input type="submit" class="p-2 submit btn text-light" value="Sign in" style="background-color: #6C4AB6" id="submit">
                        </form>
                    ...
                    <div id="register_form_holder" class="register_form_holder w-100 d-none">
                        ...
                        <form action="/checkRegister" method="POST">
                            ...
                            <input type="submit" class="p-2 submit btn text-light" value="Register" style="background-color: #FEB139" id="register_desktop">
                        </form>
    ...
    <div class="mobile_mode login_bg d-none" id="mobile_mode">
        <div class="container overflow-auto d-flex flex-column justify-content-center" style="height: 100vh;width:100%;">
            {{-- IMAGE --}}
            ...
            <div class="px-4" style="height: 50%">
                {{-- LOGIN FORM --}}
                <div id="login_form_holder_mobile" class="text-center login_form_holder w-100">
                        {{-- TITLE SUBTITLE --}}
                        <div class="title text-light">PorTable</div>
                        <p class="mb-5 text-light" style="font-size: 1.1em">Order Table & Enjoy with your Friend and Family, because food tasted better when you eat with them in a good mood</p>
                        {{-- FORM --}}
                        <form action="/checkLogin" method="POST" class="mb-4">
                            @csrf
                            <input class="px-3 mb-3 w-100 bg-light rounded-3" type="text" name="username" placeholder="Insert your username">
                            <input class="px-3 mb-3 w-100 bg-light rounded-3" type="password" name="password" placeholder="Insert your password">
                            <input type="submit" class="p-2 submit btn text-light" value="Sign in" style="background-color: #6C4AB6" id="submit">
                        </form>
                        {{-- LOGIN REGISTER TOGGLER --}}
                        <div class="d-flex justify-content-end w-100">
                ...
                {{-- REGISTER FORM --}}
                <div id="register_form_holder_mobile" class="text-center register_form_holder w-100 d-none">
                    {{-- TITLE SUBTITLE --}}
                    <div class="mb-3 text-light" style="font-size:2em;font-weight:bold;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">Welcome to PorTable!</div>
                    {{-- FORM --}}
                    <form action="/checkRegister" method="POST" class="mb-4">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <input class="px-3 mb-3 w-100 bg-light rounded-3" type="text" name="firstname" placeholder="Firstname">
                            </div>
                            <div class="col">
                                <input class="px-3 mb-3 w-100 bg-light rounded-3" type="text" name="lastname" placeholder="Lastname">
                            </div>
                        </div>
                        <input class="px-3 mb-3 w-100 bg-light rounded-3" type="text" name="username" placeholder="Username">
                        <input class="px-3 mb-3 w-100 bg-light rounded-3" type="text" name="number" placeholder="Phone">
                        <div class="row">
                            <div class="col">
                                <input class="px-3 mb-3 w-100 bg-light rounded-3" type="text" name="password" placeholder="Password">
                            </div>
                            <div class="col">
                                <input class="px-3 mb-3 w-100 bg-light rounded-3" type="text" name="password_confirmation" placeholder="Password Confirm">
                            </div>
                        </div>
                        <input type="submit" class="p-2 submit btn text-light" value="Register" style="background-color: #FEB139" id="submit">
                    </form>
                    {{-- LOGIN REGISTER TOGGLER --}}
