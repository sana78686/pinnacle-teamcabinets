        ...
        <div class="tc-checkout__pay-fields">
            <div class="row g-1">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="debit_checkout_address" class="form-control form-control-sm" value="{{ old('debit_checkout_address') }}">
                ...
                <div class="col-6">
                    <label class="small">Exp <span class="tc-req">*</span></label>
                    <input type="text" name="debit_expiry_date" class="form-control form-control-sm" placeholder="MM/YY" title="Format: MM/YY e.g. 09/25" value="{{ old('debit_expiry_date') }}">
                    <div class="field-error err_debit_expiry_date"></div>
                </div>
                <div class="col-6">
                    <label class="small">CVV <span class="tc-req">*</span></label>
                ...
                <div class="col-12">
                    <label class="tc-checkout__terms small mb-0">
                        <input type="checkbox" name="membership_agree" value="1">
                        <span>I agree to the Membership Terms and Conditions.</span>
                    </label>
