...
/**
 * cart_data — legacy CI Team Cabinets (same schema as database/migrations/tenant copy).
 * Shared DB setup: run php artisan migrate (and tenants:migrate if you use both paths).
 */
