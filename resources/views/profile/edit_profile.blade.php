        ...
        <div class="col-sm-12">
            <div class="p-0 b-r-0">
                <div class="p-3 card-body">
                    <form class="f1" method="POST" action="{{ route('profile_update') }}" enctype="multipart/form-data">
                        @csrf
                        <!-- @method('PATCH') -->
                        <div class="row">
                            <!-- Domain Name Field -->
                            ...
                            <div class="col-md-6">
                                <!-- Company Name Field -->
                                <div class="form-group">
                                    <strong for="company-name" title="Enter the official name of your company.">Company
                                        Name</strong>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <strong for="email-address"
                                        ...
                                        Address</strong>
                                    <input class="form-control" id="email-address" name="email_address" type="email"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <strong for="contact-number"
                                        ...
                                        Number</strong>
                                    <input class="form-control" id="contact-number" name="contact_number" type="tel"
                                        placeholder="Enter your contact number (e.g., +1234567890)" required autofocus
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single col-sm-12 form-control b-r-0" id="country_id"
                                        name="country_id" required data-toggle="tooltip" title="Select the Country">
                                        @foreach ($countries as $country)
                                        <option value="{{ $country->id }}" {{ $country->id == $user->country_id ?
                                            'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single col-sm-12 form-control b-r-0" id="state_id"
                                        name="state_id" required data-toggle="tooltip" title="Select the state">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="zip-code" name="zip_code" type="text"
                                        placeholder="Postal code" value="{{ old('zip_code', $user->zip_code) }}">
                                </div>
                            </div>
