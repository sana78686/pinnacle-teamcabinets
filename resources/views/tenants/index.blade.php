                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Getting start with your project custom requirements using a ready template which is quite
                            difficult and time taking process, Poco Admin provides useful features to kick start your
                            project development with no efforts !</p>
                        <ul>
                            <li>
                                <p>Poco Admin provides you getting start pages with different layouts, use the layout as per
                                    your custom requirements and just change the branding, menu & content.</p>
                            </li>
                            <li>
                                <p>Every components in Poco Admin are decoupled, it means use only components you actually
                    ...
                    <div class="card-body">
                        ...
                        <blockquote>
                            <p>
                                ...
                                libero at sagittis mollis, tellus est malesuada
